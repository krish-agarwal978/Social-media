    ...
    <header className="p-3  text-bg-dark">
      <div className="container-fluid px-0">
        <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <Link
            to="/"
            className="fs-4 fw-bold text-primary me-3 text-decoration-none"
          >
            Social Media
          </Link>
          ...
          <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  `nav-link px-2 text-white ${isActive ? "active" : ""}`
                }
              >
                Home
              </NavLink>
      ...
      >
        <div className="offcanvas-header border-bottom border-secondary">
          <h5 className="offcanvas-title" id="offcanvasReadmeLabel">
            About this Project
          </h5>
          <button
            type="button"
        ...
        <div className="offcanvas-body">
          ...
          <ul className="list-unstyled">
            ...
            <li className="mb-2">
              <strong>Features:</strong> Dark mode, infinite scroll, user auth.
            </li>
            <li className="mb-2">
              <strong>Tech Stack:</strong> React, Bootstrap 5, Vite.
            </li>
          </ul>
